-- création de la base de bonnée et son chargement 
CREATE database biblio_base;
use biblio_base;

-- création de la table oeuvre et ses chamops
...
-- création de la table livres et ses chamops
...
-- création de la table adherents et ses chamops
...
-- création de la table emprunter et ses chamops
